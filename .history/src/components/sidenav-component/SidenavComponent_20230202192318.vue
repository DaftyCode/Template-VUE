<template>
  ...
  >
    ...
    <div class="header-body">
      ...
      >
        <div class="icon-menu" :class="{ 'is-menu-hovered': isMenuHover && itemId === item.id }">
          <i :class="item.icon" style="font-size: 2rem"></i>
        </div>
        <div class="link-menu" :class="{ 'is-menu-hovered': isMenuHover && itemId === item.id }">
          <RouterLink :to="{ name: item.link }" :class="{ 'is-menu-hovered': isMenuHover && itemId === item.id }">{{ item.name }}</RouterLink>
        </div>
      </div>
    </div>
  </nav>
