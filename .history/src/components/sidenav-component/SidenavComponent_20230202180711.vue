<template>
  ...
  >
    ...
    <div class="header-body">
      <div class="menu-item" @mouseenter="isMenuHover = true" @mouseleave="isMenuHover = false">
        <div class="icon-menu" :class="{ 'is-menu-hovered': isMenuHover }">
          <i class="pi pi-home" style="font-size: 2rem"></i>
        </div>
        <div class="link-menu" :class="{ 'is-menu-hovered': isMenuHover }">
      ...
      <div class="menu-item" @mouseenter="isMenuHover = true" @mouseleave="isMenuHover = false">
        ...
        <div class="link-menu" :class="{ 'is-menu-hovered': isMenuHover }">
          <RouterLink :to="{ name: 'news' }">Noticias</RouterLink>
        </div>
      </div>
    </div>
  </nav>
